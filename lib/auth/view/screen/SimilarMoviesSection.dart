...
class SimilarMoviesSection extends StatelessWidget {
  ...
  SimilarMoviesSection({super.key, required this.movieId});
          ...
          if (state is SimilarMoviesLoading) {
            ...
            return SizedBox(
              ...
              child: GridView.builder(
                ...
                itemBuilder: (context, index) {
                  final movie = movies[index];
                  final posterUrl = movie.largeCoverImage != null
                      ? (movie.largeCoverImage!.startsWith("http")
                            ? movie.largeCoverImage! // YTS
                            : "https://image.tmdb.org/t/p/w200${movie.largeCoverImage}") // TMDB
                      : "https://via.placeholder.com/120x160"; // Placeholder
